<link type="text/css" rel="stylesheet" href="../css/bought_style.css">
<?php
/**
...
<div class="headline jumbotron">
    <div class = "container">
        <h1 align="center">Item's Bought</h1>
    </div>
</div>
...
<div class="items">
    <div id="nav" class="cartitems container">
        <ul>
            ...
            $q = "select * from transaction where buyer = '$username';";
            ...
            if($r && mysqli_num_rows($r) > 0) {
                ...
                while($row = mysqli_fetch_row($r)) {
                    ...
                    echo "<div>";
                    if($shipped == "Yes"){
                        echo "<a href='shipped.php?itemid=$id' class='btn btn-success' role='button'>Item Was Shipped</a>";
                    }
                    else{
                        echo "<a href='shipped.php?itemid=$id' class='btn btn-danger' role='button'>Item Pending</a>";
                    }
                    echo "</div>";
                    echo "</div>";
                    echo "<div class='col-sm-1'></div>";
